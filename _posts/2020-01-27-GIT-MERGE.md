...
Personally I feel `merge` should be used when a lot of developers are working on your team! In SDLC, you are the owner of the feature you are working on(branch `b1` from the above example)! In the same way, your colleague is the owner of branch `b2`. So **do you care** about all the **interim commits**(`C3`&`C4`) performed by your colleague to branch `b2`?
